...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\xampp\htdocs\plazaHotelChain\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\xampp\\htdocs\\plazaHotelChain\\public\\storage','logging.default','logging.deprecations.channel',
...
'web','api',);
        registerArgumentsSet('routes', 'login',
'register','view_change_cancel_reservation.index','register.post','login.post',
'logout','password.request','password.email',
'password.reset','password.update','book-residential-suite.create','book-residential-suite.store','make_new_reservation.create','make_new_reservation.store','view_change_cancel_reservation.cancel','view_change_cancel_reservation.edit',
'view_change_cancel_reservation.update','customer.booking_history','travel_company_booking.create','travel_company_booking.store','travel_company_dashboard',
'storage.local',);
        registerArgumentsSet('views', 
'about','auth.passwords.email','auth.passwords.reset','book_residential_suite_C','book_residential_suite_edit',
'check-in','check-out','clerk_dashboard','contact','customer.dashboard',
'customer_room_types','customer_view_checkout','home','login','make_new_reservation',
'make_new_reservation_edit','manager_dashboard','master','no-show_customer_report','occupancy_report',
'register','reports','revenue_report','test','travel-company.dashboard',
'travel_company_booking','travel_company_room_types','travel_company_view_checkout','view_booking_history_C','view_change_cancel_reservation_C',
...
'SESSION_DOMAIN','SESSION_SECURE_COOKIE','BROADCAST_CONNECTION','FILESYSTEM_DISK','QUEUE_CONNECTION',
